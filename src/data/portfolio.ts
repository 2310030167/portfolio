...
export const personalDetails = {
  ...
  companyUrl: "https://devilslab.co.in/",
  companyName: "DevilsLab",
  portfolioUrl: "https://portfolio-xi-silk-76.vercel.app/",
...
export const experiences: Experience[] = [
  ...
  },
  {
    ...
    description:
      "Mentored the engineering team on data infrastructure, IoT sensor stream processing, and predictive models for high-reliability environmental risk management systems.",
    highlights: [
      "Mentored and guided team members on building low-latency IoT sensor stream processing and real-time environmental monitoring modules in Python.",
      "Advised on backend API design, secure data pipelines, and telemetry data processing architecture.",
      "Guided the development of predictive machine learning pipelines to optimize real-time alert precision and reliability.",
      "Conducted system testing reviews and performance optimization across distributed sensor nodes.",
    ],
    skills: ["Technical Mentorship", "Python", "IoT Sensor Streams", "Predictive ML", "Backend APIs", "System Optimization"],
  },
];
